...
public class Acesso extends javax.swing.JFrame {
    ...
    private void alterarTela2() {
        votacaoResultado nomequalquer = new votacaoResultado();
        nomequalquer.setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/logo-je.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txtLogin.getText().equals("root") && txtSenha.getText().equals("root")) {
            alterarTela();

        } else if (txtLogin.getText().equals("root") && txtSenha.getText().equals("9999")) {
            alterarTela2();
